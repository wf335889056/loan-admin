            ...
            <FormItem label="还款方式和利率:">
              <template>
                <p>还款方式:
                  ...
                  <div class="ddd" v-if="form.input == 3 || form.input == 6 || form.input == 9 || form.input == 12">每期天数:
                    <InputNumber :min="0" v-model="form.input" style="width: 100px;" size="large"></InputNumber>天
                  </div>
                </p>
                <div v-if="form.input < 14">
                  利息计算周期:
                  <Select v-model="form.input" size="large" clearable>
                ...
                <div v-else>
                  还款日配置:
                  <div class="ddd">
                    每月固定还款日期: <InputNumber :min="0" v-model="form.input" style="width: 100px;" size="large"></InputNumber>号
                  </div> 
                  <div class="dd">
                    最后一期还款日期:
                    <Select v-model="form.input" size="large" clearable>
                  ...
                  <div v-if="form.input == 13" class="dd">
                    ...
                    <div class="dd">支持放款周期:
                      <CheckboxGroup v-model="form.input" size="large">
                        ...
                        <Checkbox label="9">
                          <InputNumber :min="0" v-model="form.input" size="large"></InputNumber>天
                        </Checkbox>
                      </CheckboxGroup>
                    </div>
                  </div>
