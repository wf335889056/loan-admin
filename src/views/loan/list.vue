  ...
  data() {
    return {
      ...
      columns: [
        ...
        render: (h, params) => {
          return h('div', params.row.repaymentStatus == 1? '未还款' : params.row.repaymentStatus == 2? '还款完成' : params.row.repaymentStatus == 3? '逾期' : params.row.repaymentStatus == 4? '还款中' : '')
        } },
        { title: '账单日期', key: 'billDate', align: 'center' },
        { title: '预计还款时间', key: 'billEndDate', align: 'center' },
        { title: '实际还款时间', key: 'backMoneyTime', align: 'center' },
